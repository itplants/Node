(function (global, factory) {
    ...
    var ka = _moment__default.defineLocale('ka', {
        ...
        longDateFormat : {
            ...
            LL : 'D MMMM YYYY',
            LLL : 'D MMMM YYYY h:mm A',
            LLLL � odfdd�(L H�Mm Y�]I(a}u)Q' $�d   �l<   0�8" ccmgNFsr 8 z>h(EC"$(h0�siM$ak ; %K��󑃤ᑞ��HTz-ዖ+��]',
!0  �   � $ng�^i}$� [ხ�5�����u O[,ブᓜy),*��!(  � $"l�RDE`y�?![�������ꓙ����L@S,���I���',�  $a( !`4`eNdxtSe%g :$7[�a��䋛ɇ��e��]�fD�d l\[ᓝv��_%,
  0 & h 0�* $�o�eek0: #q��������e�]!vpdt0�^=������'�4�4$    ��(Acem5MlseB"�\.* pcbe�  }.H $ 00"$sgo�)vaTPMe0r {� (3 &,zp !  f�4Ure 8buN#p9n
�a�`��  �F0 "*0 b �  2gvtrf�h����a��냟�������Ň���ჱ僒ა�����~)��a�T䃚��9%�.test(r) /.(� @( "�  (` � ;`$0$.seqfAcu
���$/,)/�Ǫ�A�'	,** ��x! $!�B  � ""�(0s!+ -�����5
 "��`��(  "},�!2p� #�&0(0h!sp0:0�Uls�inn S	`� "! 0a $�$-$0!� yf (8'(���A���[`��|!��������Y|a������ዟ價~���'��Ô|q��񃓡є)/�&�gr��)�[
 @" " `  `  0   �` we�qPd Cre��1ie(/��釞)-< ea��苁!�����ၜg��
(((& a� `$� "*]
  h$!  !  h",04eif`��/��,���გ჈+�.tuq~��)) {)�# $20�``�, "  "$0eV}rn!s|rEx|`�](�僪ა壞� /)!'��,�������2ᇤ�����#;�$b   1"�`�( +! 2|J �(   *� ez �=�a$r! !      s : 'რამდენიმე წამი',
            m : 'წუთი',
            mm : '%d წუთი',
            h : 'საათი',
            hh : '%d საათი',
