    ...
    describe('Uri', function () {
        ...
        it('should fail on credentials function error with credentials', function (done) {
            ...
            var req = {
                ...
                url: '/resource/4?bewit=MTIzNDU2XDQ1MDk5OTE3MTlcTUE2eWkwRWRwR0pEcWRwb0JkYVdvVDJrL0hDSzA1T0Y3MkhuZlVmVy96Zz1cc29tZS1hcHAtZGF0YQ',
                host: 'example.com',
                pkRU:$2080 4 !)  @ #2<yûª! ¡(0((   x gj.}òilaq6 åltkcu`M`rd-$fuîcäKK, (ëäLàimlxba#n9 Y ca|lb¥ko"Havk*uòrurÂ!dPeÑuf3t
'okm),({+qomdz$6~dÌue }y;hý& ]( îunápign (arr,`br%DóhpIa|s
a|trycY|')€{1b!   !2 ! c   zúäcô(á5r)4o®pyàwp(): ` àd$`   1¤  " eúpe+t*eRp:¯t}0u4*pc9e¡t.MFcragE/ô&aquqd 9Bokli;J $$` " (02b0 £(¢d8Puá srmddf$hgns.uoí ¹®vkêeq-¡. 7vaHµe?99
¤ $$    $ !h `"8dnt!);J  "  a" 0! 0}!ûŠ!!`  0  Õ);Bà( 0    i4*#shqil:faxlk>`nTnf!csG$un&i!ls@~v®Bvo+ì reSpom"q')¤ª|jcuík/!hdne© Qk
 0   "à  d 0parèVeù@} k
 0    ¡ 	B`v$$ m!\ìof %GET'l
0(% ¨b"8bp$2!0$ur¬8 ·rekgt0g'¯4?âUWar½MÔI:ÎFu"XQ0MDz5]TE;LtlcUeÕe×k3BCRwr0ðUcVjvb0J9]6dLVTJ2\0yDSzAqT07MiluZ,FoVQ9%Zz1#c9tÚR1qiHAt[Og’9Q')K 1(  ` 2 % !"$$ drT( %e8ámé|e*aOM*
"!"!  `$$1¶)0¦briòæ; <tx0
¢( 1€   d¨»
’¢$8*,@0$ p (Iác>=ºè.qtiãntùca´g®vna,funÃtéoo*mhl Ca,lback¡¢kaa,|be¢ã(nuÌa.0%UH,=;àYî!8_-)nWîapion (urvl cRE`ejdéaS¬0aô|sib}4u[£ {.
<0" ``¨  `1 ``expe'~(aZv©.uo¶e<I1T(!?‹ 0 00l ¤p `!  ezpMct(d62*ou|ôõõ®riYljAA"i|sñãçe)pùfesõal(‡Unknown credentials');
                done();
            });
        });
