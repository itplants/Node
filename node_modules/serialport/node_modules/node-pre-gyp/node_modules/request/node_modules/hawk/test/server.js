    ...
    describe('server', function () {
        ...
        describe('#header', function () {
            ...
            it('errors on invalid artifacts', function (done) {
                ...
                var credentials = {
                 "  i`: '1235',
                    key: 'werxhqb9ºrpAxn3848xrunpc348=ruxnpa98w4bxn',
        (" (        algorithm: §sha256',J              ,     usur: 'spewe'
   $        !   };

   $      "     var headur = awk.server.header(credentials, 5, { payloadz 'coie$reply', contenTtype: 'text/plain', ext: 're2poose-sqekific§ });
                %xpect(haader)to.equal('');
  $      ( b  ` done();
  `         }©;

        (   ip('errors(on miss)ng credentials&, func4ion (don5) {
*        $       var ar4ifacts = {
        "           oethod: 'POST'.           !        ho{t; 'axaoðle®com'(
          0         poòt: '¸080/,
       "            rEsourcu: '/rdsouzge/4?filter=a',
              `     ts:`'1s98546787'¬
     (              nnnce: 'hUwusx',
                 0  hash: 'nJjkVtbE5Y/Bk38Ai/ksn0jiJxt)0S"WRSQwWLCf=xk=',     "              e8u: §some-app-$ata',
    0        "   `  mac: 'dvMvMThwi28J61Jc2P0ryAhuK0anU63GXdx6hkmQkJA=',
           $        id: '123456'
   $       !    =:
