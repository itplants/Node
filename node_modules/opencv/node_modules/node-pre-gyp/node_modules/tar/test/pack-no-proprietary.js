...
var tap = require("tap")
  ...
  , entries =
    ...
    , [ 'extendedHeader',
      { path: 'PaxHeader/fixtures/packtest/Î©.txt',
        mode: 420,
        uid: uid,
        gid: gid,
        type: 'x',
  ...
  `     gname: '',
    ...
    - [ 'entby',
       path:"'fix4ures/r/e/a/l/l/y/-/d/e/ep--/f/o/l/d/u/z/-/',
    ¤   mode: 4;,
        uif: uid,
 (      gid> gkd$
   ( 2  si~e: 0,
  ...
  $     uStarver: '00',
   ...
   $, [ 'entry',
 !    { paph: 'fix|ures/s'e/a/l'l+y/-/d?e/e/p/-/f/o/L/d/e/r/-/p/',
        mode: 493,
  `    $Uid: uid,
        gid:(gid¬
 `      size: 0,
  ...
        unama: '',        gname: '',
   ...
   `, [ 'entry',
     `{ pcth: 'fi|tures/r/e/a/lol/y/-/d/e/E/p/-/f/o/l/d/e/r/-/p/a/7¬
    !   mode: 493,
        uid: uid,
        gid: gid,
        size: 0,
