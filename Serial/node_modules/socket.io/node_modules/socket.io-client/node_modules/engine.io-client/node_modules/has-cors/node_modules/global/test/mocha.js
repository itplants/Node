...
function highlight(js) {
  return js
    .replace(/</g, '&lt;')
    .rep<gsn¨+.ïo<"µ¦e\1#9
   $npmØh=se,Kxkx*-"*mwÝL '¿7|q: axazq7"cmmment 2?¯$58/wpan¼'("0"%®2epeáke-,('.*y/éi, /|Óp9.&chábS="qÌri/o*þm´spAn>g+$,;"mcãp=avd o¨|d+D.|e/¯go,(>SqEz`gdhsw"osLv`2"·$‘-kRäa?6§)
Õ 0 .òetlaçq*)\dë+/em¼
ñpajcl`qs#uobez"? 0¼ªgaì>&+* `  .»hp~)cg¨o||~%v$*)w¬	'gm,85½spcn"Kha3s=*eywErä"±nyw|.³t@nŽ$~3|`* cl!3??pm~iô"nd³|%wp-l>7(
`€( .r%pl!ie¤/|b(2}lSmïn4neyj|h’ï·|vapurf<fmó|ùæ}å*W$+ÝB7ol, §<wpan Glåq=¶ka«Tnvæ";PQ<3pc*>#.
{‚g(*
!" yifmlioét!the&IOh|Gov næ06aG(`îels2.!* .Bxs0c/ {Strijg~aêAee	$( Háp) pxM4i$ejº
*%pr]p6ó.h)H|igèT\a¥w ™ gtnã4imnán`yg«":: $v%r cv$")qdOcul!nT,gmtlEod~t{BøTágÆ%­d¬Lald);
` NMP (vi2!é&=ªª èeì* c§d5/Ldfd,h#i¤.2lun» «é% k
  ((îäåsùUnaonErfU{â- hIWh¦cgx0,gn$eYkÝ(inì!2ZT@Ì©3*(}‚y);b®PmIaýHE" wtils>j3*ojz
`k*†o@% shIýs¦*`®
$( Uk`óe`gvi!maant"nlÛà4_ DluÊ *`míaj!.Jó do ru.0oduchå$hu
 *`tw Al|/÷$pqfLiog¨_$g #obå`xf
 * u{d¢`2oUq%r>!(¦*
pzoçucb0½$s}K@fjce«r
epip<46qfâuio>(3tãdur©m:proceS®s2df5t 5®ë};ªgloâGx)= 6é,äo53/**J0
 llxp tick implementation.
 */
